...
TEST(controllerAndSpaceDescriptionTests, scalarProportionalController)
{
	FOUR_DOF_ROBOT;
	controller::Ptr ctrl(
...
TEST(controllerAndSpaceDescriptionTests, RotationalProportionalController)
{
	FOUR_DOF_ROBOT;
...
TEST(controllerAndSpaceDescriptionTests, spaceDescriptionScalar)
{
	FOUR_DOF_ROBOT;
	FOUR_DOF_KDL_ROBOT;
...
TEST(controllerAndSpaceDescriptionTests, spaceDescriptionRotation)
{
	FOUR_DOF_ROBOT;
	FOUR_DOF_KDL_ROBOT;
...
TEST(controllerAndSpaceDescriptionTests, spaceDescriptionRotationOwnFrame)
{
	FOUR_DOF_ROBOT;
	FOUR_DOF_KDL_ROBOT;
